<script lang="ts">
	...
	import { communityTable } from '$lib/v2/constants/constants';
	import { communityContent } from '$lib/v2/constants/postContent';
</script>

<div class="container">
	<PostContainer>
		<PostTable table={communityTable} />
		<PostBody body={communityContent} />
	</PostContainer>
</div>
